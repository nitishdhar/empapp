	...
	<div data-role="header">
  	...
  	<div data-role="content"> 
		...
		$sql = "select e.id, e.firstName, e.lastName, e.managerId, e.title, e.department, e.city, e.officePhone, e.cellPhone, " .
				"e.email, e.web, e.picture, m.firstName managerFirstName, m.lastName managerLastName, count(r.id) reportCount " . 
		...
		?>	
    		...
    		<ul data-role="listview" data-inset="true" class="action-list">
				...
				if (!is_null($employee->web))
		    	{
					echo "<li><a href='#' onClick='launchBrowser()' id='employee_web' data-url-value='$employee->web'><h3>Website</h3><p>$employee->web</p></a></li>";
				}
		    	?>
    		</ul>
